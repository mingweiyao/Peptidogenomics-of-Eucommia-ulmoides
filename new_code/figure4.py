...
def extract_fasta_from_gtf(hit_transcript, db_path, genome_fasta):
    ...
    SeqIO.write(hit_transcript_fasta_output, "/media/wanglab/caca/work_mechanism/new_file/02figure/figure4/new_transcript/hit_transcripts.fa", "fasta")
    SeqIO.write(hit_transcript_fasta_output_extra, "/media/wanglab/caca/work_mechanism/new_file/02figure/figure4/new_transcript/hit_transcripts_extra.fa", "fasta")
...
def run_scan_and_output(stats, hit_transcript_fasta, max_scan_nt=MAX_SCAN_NT, nproc=THREADS):
    ...
    return stats_update
def main():
    peptide_info = "/media/wanglab/caca/work_mechanism/new_file/02figure/figure4/new_transcript/finally_expressed_sp_info_annotated.xlsx"
    hit_transcript_gtf = "/media/wanglab/caca/work_mechanism/new_file/02figure/figure4/new_transcript/hit_transcripts.gtf"
    genome_fasta = "/media/wanglab/caca/work_mechanism/new_file/02figure/Eu_genome_modified/Eu_genome.fasta"
    out_cand = "/media/wanglab/caca/work_mechanism/new_file/02figure/figure4/new_transcript/hit_transcript_predict_orf.csv"
    db_path = "/media/wanglab/caca/work_mechanism/new_file/02figure/figure4/new_transcript/hit_transcripts.db"
