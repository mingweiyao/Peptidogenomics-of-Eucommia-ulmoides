...
data_df = pd.read_excel("/Volumes/caca/work_mechanism/new_file/02figure/figure5/rubber/rubber/rubber_count_5_fpkm.xlsx")
mapped_ids = id_mapping_df['ID']
mapped_df = data_df[data_df['GeneID'].isin(mapped_ids)]
mapped_df.to_excel("/Volumes/caca/work_mechanism/new_file/02figure/figure5/rubber/rubber/rubber_count_fpkm_filter.xlsx", index=False)
