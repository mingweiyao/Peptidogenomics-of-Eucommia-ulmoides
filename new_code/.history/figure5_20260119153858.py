...
def filter_excel_by_log2fc_pvalue(input_excel, output_excel, log2fc_col="log2FC", 
    ...
    for sheet in xls.sheet_names:
        ...
        # 筛选条件
        filtered = df[(df[log2fc_col].abs() > log2fc_cutoff) & (df[pvalue_col] < pvalue_cutoff)].copy()
...
input_excel = "diff_expression_results.xlsx"
output_excel = "filtered_log2FC_pvalue.xlsx"
