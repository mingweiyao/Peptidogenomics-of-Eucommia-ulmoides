...
# 提取相关肽的信息，用于肽分类的构建
import pandas as pd
id_file = "/Volumes/caca/work_mechanism/new_file/02figure/figure5/rubber/rubber_gca_pairs_with_pearson.xlsx"
...
id_express.to_excel("/Volumes/caca/work_mechanism/new_file/02figure/figure5/rubber/deseq_analysis_diff_pep_info.xlsx", index=False)
