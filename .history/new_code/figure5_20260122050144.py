...
import pandas as pd
import os
IN_FILE = "/Volumes/caca/work_mechanism/new_file/02figure/figure5/rubber/correlation/output.xlsx"
OUT_FILE = "/Volumes/caca/work_mechanism/new_file/02figure/figure5/rubber/correlation/output_geneid.xlsx"
VAR_COL = "GeneID"
def main():
    xls = pd.ExcelFile(IN_FILE)
    cols = {}
