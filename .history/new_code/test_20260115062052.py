...
genome_file = "/Volumes/caca/work_mechanism/new_file/02figure/Eu_genome_modified/Eu_genome.fasta"
genome_dict = {rec.id: str(rec.seq) for rec in SeqIO.parse(genome_file, "fasta")}
print(genome_dict['GWHBISF00000489'][12087896:12088350])
