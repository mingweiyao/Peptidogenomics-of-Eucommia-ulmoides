...
<!-- EXECUTION CHECKLIST (DO NOT DELETE) -->

Coverage checklist for this section:
- [ ] uORFs, dORFs, lncRNA-derived smORFs all mentioned
- [ ] Translation evidence explicitly distinguished from transcription
- [ ] Ribo-seq limitations discussed (scanning noise, reproducibility)
- [ ] Proteomics treated as confirmatory, not comprehensive
- [ ] No functional claims without L5 evidence
